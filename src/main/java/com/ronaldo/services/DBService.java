...
import com.ronaldo.domain.PagamentoComCartao;
...
import com.ronaldo.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "automacaoamericanas@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ronaldo.ssouzasilva@gmail.com", "23864904676", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("333333333", "9999999999"));
		...
		Endereco e3 = new Endereco(null, "Rua Floriano", "2106", null, "Centro", "38740000", cli2, c2);
